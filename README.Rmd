...
## Issues
There seems to be still an issue with the normalization of the result: When
processing the same signal with different batch sizes, different values can
arise. This is of course not desired.
